<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="503ErrorInternalServer.aspx.cs" Inherits="OnlineUserInterview.CustomError._503ErrorInternalServer" %>
...
<head runat="server">
    ...
    <link href="Content/styleError.css" rel="stylesheet" />
    <title>503 - Error Ocucurred</title>
</head>
<body>
    <form id="form1" runat="server">
        <div class="Container">
            ...
            <h1 class="MainTitle">An error has occurred
            </h1>
